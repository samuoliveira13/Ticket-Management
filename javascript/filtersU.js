document.addEventListener("DOMContentLoaded", function() {
    document.getElementById("department-formU").addEventListener("change", updateTable);
    document.getElementById("user-formU").addEventListener("change", updateTable);
    document.getElementById("status-formU").addEventListener("change", updateTable);
    document.getElementById("priority-formU").addEventListener("change", updateTable);
    ...
    function updateTable() {
        ...
        xhr.open("POST", "../api/filtersU.php");
