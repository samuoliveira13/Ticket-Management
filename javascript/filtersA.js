document.addEventListener("DOMContentLoaded", function() {
    document.getElementById("department-formA").addEventListener("change", updateTable);
    document.getElementById("user-formA").addEventListener("change", updateTable);
    document.getElementById("status-formA").addEventListener("change", updateTable);
    document.getElementById("priority-formA").addEventListener("change", updateTable);
    ...
    function updateTable() {
        ...
        xhr.open("POST", "../api/filtersA.php");
